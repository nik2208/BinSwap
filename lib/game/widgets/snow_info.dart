...
class SnowInfo extends StatelessWidget {
  final bool isDark;
  const SnowInfo({this.isDark = true, super.key});
    ...
    return Row(
      children: [
        Container(
          ...
          width: 50.0,
          child: Image.asset('assets/images/icons/specials/snowflake.png'),
        ),
        const SizedBox(width: kDefaultSmallPadding),
        Expanded(
          child: Text(
            AppLocalizations.of(context)!.gameInfosHow2playSnowDescription,
